...
export default function ProductDetail () {
    ...
    const isProductInOrders =  userOrders.some(order =>
        ...
        <Fragment>
            ...
            <Fragment>
                ...
                <div className="row f-flex justify-content-around">
                    ...
                    { user && isProductInOrders ?
                    <button onClick={handleShow} id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal" disabled={!isProductInOrders}>
                                Submit Your Review 
                    </button> : user ? 
                    <div id="review_btn" className="btn btn-primary mt-4"> Buy to Post Review</div> :
                    <div id="review_btn" className="btn btn-primary mt-4"> Login and Buy to Post Review</div>
                    }
                ...
                <ProductReview reviews={product.reviews} user={user} /> : null
                }
            </Fragment>}
        </Fragment>
    )
